...
import ExampleImage from "../../../common/images/static/mhimg2.png"
import ExampleImage2 from "../../../common/images/static/mhimg.png"
        ...
        <section className={styles["info-grid"]}>
            ...
            <div className={styles["info-grid__blocks-wrapper"]}>
                <article className={styles["info-grid__blocks-wrapper__block"]}>
                    <Image className={styles["info-grid__blocks-wrapper__block__image"]} src={ExampleImage} alt={""} />
                    <p>Lorem ipsum, lorem lorem</p>
                </article>
                <article className={styles["info-grid__blocks-wrapper__block"]}>
                    <Image className={styles["info-grid__blocks-wrapper__block__image"]} src={ExampleImage2} alt={""} />
